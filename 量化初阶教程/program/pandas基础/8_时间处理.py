...
# print(df['交易日期'] + pd.Timedelta(days=1) + pd.Timedelta(hours=10) + pd.Timedelta(seconds=30))  # 增加一天，Timedelta用于表示时间差数据，[weeks, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds]
