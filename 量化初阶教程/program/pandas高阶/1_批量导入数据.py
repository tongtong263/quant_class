...
df = pd.read_csv(
    r'C:\Users\sgwat\Desktop\quant_class\量化初阶教程\data\basic-trading-data\stock_data\sh600004.csv',
    encoding='gbk',
...
# 将数据存入hdf文件中
all_data.to_hdf(
    r'C:\Users\sgwat\Desktop\quant_class\量化初阶教程\data\basic-trading-data\stock_data\a_stock.h5',
    key='all_data',
    mode='w'
)
